...
describe("FeedContext Structured Synthesis validation", () => {
  ...
  it("renders a complete Briefing Page from Structured Synthesis through the packed helper", async () => {
    ...
    expect(html).toContain('data-layout-role="lead"');
    expect(html).toContain('data-layout-role="major"');
    expect(html).toContain('data-display-format="analysis"');
    expect(html).toContain('data-body-role="lead_paragraph"');
    expect(html).toContain('data-body-role="detail_paragraph"');
    expect(html).toContain('data-body-role="context_paragraph"');
    expect(html).toContain('<a href="https://example.com/release">');
    expect(html).toContain('<section class="source-index" aria-label="Source index">');
    expect(html).not.toContain("Supported by");
    expect(html).not.toContain('class="source-cluster"');
    expect(html).not.toContain('class="source-chip"');
    expect(html).not.toContain('class="source-tooltip"');
    expect(html).not.toContain('class="inline-citation"');
    expect(html).not.toContain('class="citation-tooltip"');
