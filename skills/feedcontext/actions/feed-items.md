...
```bash
feedcontext item list
feedcontext item list --subscription-id sub_123
feedcontext item list --limit 100 --cursor '<next_cursor>'
...
```bash
feedcontext item list --limit 100
feedcontext item list --cursor '<next_cursor>'
feedcontext item list --subscription-id sub_123
feedcontext item list --keyword 'agent'
feedcontext item list --keyword 'agent' --search-content
feedcontext item list --published-after 1700000000000
feedcontext item list --published-before 1800000000000
feedcontext item list --id item_1 --id item_2
feedcontext item list --all --subscription-id sub_123
feedcontext item list --all --max-pages 20
```
...
```bash
feedcontext item get --id item_123
feedcontext item get --id item_123 --cursor '<next_content_cursor>'
```
...
feedcontext item get-many --ids-file item-ids.txt --concurrency 8
feedcontext item get-many --ids-file item-ids.json --max-chars 20000
```
